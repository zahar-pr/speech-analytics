...
from models import MangoRecord
from mixin import MangoMixin
from mango_extractor import MangoExtractor, use_logging
from fastapi import HTTPException
from typing import NoReturn

@use_logging(log_file='mango')
class MangoCallRecord(MangoMixin, Telephony):
    ...
    async def _get_mp3(self) -> MangoCallRecord | NoReturn:
        ...
        if self._phone_number not in phone_numbers:
            self._logger.error("ERROR: отсутствие контакта в очереди звонков. Телефония: mango office")
